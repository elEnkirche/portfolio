...
const CarouselControl = ({
  ...
  return (
    <button
      className={`z-60 w-10 h-10 flex items-center mx-2 justify-center bg-neutral-200 dark:bg-neutral-800 border-3 border-transparent rounded-full focus:border-[#6D64F7] focus:outline-none hover:-translate-y-0.5 active:translate-y-0.5 transition duration-200 ${
...
export function Carousel({ slides }: CarouselProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute flex justify-center w-full top-[calc(100%+8rem)] md:top-[calc(100%+1rem)]">
        <CarouselControl
          type="previous"
