...
export default function Contacts() {
  return (
    <div className="h-screen overflow-y-scroll snap-y snap-mandatory">
      <section className="h-screen snap-start flex items-center justify-center bg-background text-foreground">
        <MySocialIcons />
      ...
      <section className="hidden md:flex h-screen snap-start flex flex-col items-center justify-center bg-oklch(0.13 0.028 261.692) text-white">
