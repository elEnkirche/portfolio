...
export default function Contacts() {
  return (
    <div className="h-screen overflow-y-scroll snap-y snap-mandatory">
      <section className="h-screen snap-start flex items-center justify-center bg-neutral-900 text-white">
        <MySocialIcons />
      ...
      <section className="hidden md:flex h-screen snap-start flex flex-col items-center justify-center bg-blue-900 text-white">
